...
const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden bg-theme-hero pt-32 pb-24" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="max-w-[1250px] mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="flex-1 space-y-8 text-center lg:text-left">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold tracking-wide uppercase shadow-sm bg-white border border-blue-100/80">
            ...
            <span className="text-theme-secondary font-extrabold">#1 Platform Magang Mahasiswa</span>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-theme-dark leading-[1.2] tracking-tight">
            Temukan Peluang <br className="hidden sm:inline" />
            Karir <span className="text-theme-secondary relative inline-block">
              Impianmu
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
            <button className="w-full sm:w-auto text-white px-8 py-4 rounded-2xl font-bold text-base transition-all duration-300 bg-theme-primary hover:bg-theme-primary-hover shadow-lg shadow-sky-200/50 hover:shadow-sky-300/80 transform hover:-translate-y-0.5 hover:scale-[1.02] flex items-center justify-center gap-2 cursor-pointer">
              Daftar Sekarang
          ...
          <div className="pt-8 border-t border-slate-100 grid grid-cols-3 gap-4 md:gap-8 max-w-[550px] mx-auto lg:mx-0">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left hover:scale-105 transition-transform duration-300">
              <div className="w-11 h-11 rounded-2xl flex items-center justify-center bg-theme-accent border border-theme-blue flex-shrink-0">
                <BriefcaseBusiness size={20} strokeWidth={1.8} className="text-theme-secondary" />
              </div>
              <div>
                <p className="text-lg md:text-xl font-black text-theme-dark leading-none">175.324</p>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left hover:scale-105 transition-transform duration-300">
              ...
              <div>
                <p className="text-lg md:text-xl font-black text-theme-dark leading-none">97.354</p>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left hover:scale-105 transition-transform duration-300">
              ...
              <div>
                <p className="text-lg md:text-xl font-black text-theme-dark leading-none">7.532</p>
