...
const STATUS_STYLE = {
  ...
  BERKAS_DITERIMA:        { label: "Berkas Diterima",      bg: "bg-blue-50",    text: "text-blue-700",    border: "border-blue-200",    dot: "bg-blue-400" },
                    ...
                    <tr key={a.id} className="group hover:bg-slate-50 transition-colors">
                      <td className="py-2.5 pr-3 border-b border-slate-50 group-last:border-0">
                        <div className="flex items-center gap-2.5">
                          <div className="w-7 h-7 rounded-lg border flex items-center justify-center font-display text-[10px] font-semibold flex-shrink-0 bg-blue-100 text-blue-700 border-blue-200">
                            {getInitials(a.name)}
                          </div>
