  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1050px] flex items-center gap-12 bg-white py-2 px-10 rounded-2xl border-2 border-blue-300">
        <div className="w-[500px] min-h-[500px] bg-gradient-to-br from-sky-300 to-sky-400 rounded-[8px_36px_8px_36px] flex items-center justify-center p-8 relative overflow-hidden flex-shrink-0">
          <Image
        ...
        <div className="flex-1 flex flex-col justify-center py-6">
          ...
          <h2 className="text-[26px] font-extrabold text-slate-900 leading-snug mb-1.5">
            Buat akun{" "}
            <em className="not-italic italic font-bold text-sky-500">baru</em>
          </h2>
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="mb-3.5">
              ...
              <select
                ...
                className="w-full px-3.5 py-[11px] text-[13.5px] border border-slate-200 rounded-lg outline-none text-slate-800 bg-white focus:border-sky-300 focus:ring-2 focus:ring-sky-100 transition-all"
              >
